...
describe("UsagersImportCiviliteSchema schema", () => {
  it("usager VALIDE", async () => {
    expect(
      ...
      prenom: "Paul",
      surnom: "Polo",
      dateNaissance: new Date(Date.UTC(2018, 6 - 1, 15, 12)),
      lieuNaissance: "Paris",
      telephone: {
        countryCode: "fr",
      ...
      dateDebutDom: new Date(Date.UTC(2019, 3 - 1, 10, 12)),
      dateFinDom: new Date(Date.UTC(2020, 3 - 1, 10, 12)),
      datePremiereDom: new Date(Date.UTC(2019, 3 - 1, 10, 12)),
      dateDernierPassage: new Date(Date.UTC(2020, 12 - 1, 18, 12)),
      orientation: false,
      ...
      ayantsDroits: [
        {
          nom: "Dupont",
          prenom: "Paula",
          dateNaissance: new Date(Date.UTC(2018, 7 - 1, 15, 12)),
          lienParente: "ENFANT",
        },
        {
          nom: "Dupont",
          prenom: "John",
          dateNaissance: new Date(Date.UTC(1938, 7 - 1, 15, 12)),
          lienParente: "PARENT",
        },
      ],
    });
  ...
  it("usager REFUS", async () => {
    expect(
      ...
      ayantsDroits: [
        {
          dateNaissance: new Date(Date.UTC(1991, 7 - 1, 11, 12)),
          lienParente: "AUTRE",
          nom: "Auguy",
          prenom: "Marcelo",
        },
      ...
      customRef: "XX_0111",
      dateFinDom: new Date(Date.UTC(2020, 5 - 1, 12, 12)),
      dateNaissance: new Date(Date.UTC(1929, 6 - 1, 15, 12)),
      domiciliationExistante: false,
