export const USAGERS_IMPORT_COLUMNS = {
  ...
  causeInstabilite: { index: 27, label: "Cause instabilité logement" },
  causeDetail: { index: 28, label: "Si autre cause, précisez" },
  raisonDemande: { index: 29, label: "Motif principal de la demande" },
  raisonDemandeDetail: { index: 30, label: "Si autre motif, précisez" },
  accompagnement: { index: 31, label: "Accompagnement social" },
  accompagnementDetail: {
    index: 32,
    label: "Par quelle structure est fait l'accompagnement ?",
  },
  commentaires: { index: 33, label: "Commentaires" },
};
