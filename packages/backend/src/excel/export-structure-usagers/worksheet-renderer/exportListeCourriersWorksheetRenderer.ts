...
function renderWorksheet({
  ...
  function configureColumns() {
    const columns: Partial<Column>[] = [
      ...
      { key: "courrierIn" },
      { key: "courrierOut" },
      { key: "courrierOutForwarded" },
      { key: "colisIn" },
      { key: "colisOut" },
      { key: "colisOutForwarded" },
      { key: "recommandeIn" },
      { key: "recommandeOut" },
      { key: "recommandeOutForwarded" },
      { key: "appel" },
      { key: "visite" },
      { key: "loginPortail" },
    ];
    ...
    return model.usagers.map((usager) => {
      ...
      const row: XlRowModel = {
        values: {
          ...
          courrierOutForwarded: usagersInteractionsCounts.courrierOutForwarded,
          recommandeIn: usagersInteractionsCounts.recommandeIn,
          recommandeOut: usagersInteractionsCounts.recommandeOut,
          recommandeOutForwarded:
            usagersInteractionsCounts.recommandeOutForwarded,
          colisIn: usagersInteractionsCounts.colisIn,
          colisOut: usagersInteractionsCounts.colisOut,
          colisOutForwarded: usagersInteractionsCounts.colisOutForwarded,
