...
describe("Structure Service", () => {
  ...
  structureDto.adresseCourrier.actif = true;
  structureDto.adresseCourrier.adresse = "15 rue des bois, 75013 PARIS";
  structureDto.adresseCourrier.codePostal = "75013";
  structureDto.adresseCourrier.ville = "PARIS";
