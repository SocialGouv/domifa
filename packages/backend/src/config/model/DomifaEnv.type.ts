export type DomifaEnv = {
  ...
  DOMIFA_PORTAIL_STATS_URL: string;
  ...
  DOMIFA_BREVO_TEMPLATES_USER_ACCOUNT_DELETED: string;
  ...
  DOMIFA_BREVO_TEMPLATES_USER_EMAIL_UPDATE_CONFIRMATION: string;
  DOMIFA_BREVO_TEMPLATES_USER_EMAIL_UPDATE_ALERT: string;
  DOMIFA_BREVO_TEMPLATES_USER_EMAIL_UPDATED: string;
  ...
  DOMIFA_QUOTA_USAGERS_DELETE_BLOCK_PER_DAY: string;
};
