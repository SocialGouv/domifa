...
export class autoMigration1615884899669 implements MigrationInterface {
  name = "autoMigration1615884899669";

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "message_sms" ("uuid" uuid NOT NULL DEFAULT uuid_generate_v4(),
    ...
    await queryRunner.query(
      `ALTER TABLE "structure" ADD "sms" jsonb NOT NULL DEFAULT '{ "enabledByDomifa": false, "enabledByStructure": false, "senderName": null, "senderDetails": null }'`
    );
