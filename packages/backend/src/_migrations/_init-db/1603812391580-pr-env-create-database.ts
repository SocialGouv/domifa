...
CREATE UNLOGGED TABLE public.usager (
	...
	email text NULL,
	phone text NULL,
	preference jsonb NULL DEFAULT '{"email": false, "phone": false, "telephone": {"numero": "", "indicatif": "fr"}, "phoneNumber": null}'::jsonb,
	"datePremiereDom" timestamptz NULL,
	"typeDom" text NULL DEFAULT 'PREMIERE_DOM'::text,
	decision jsonb NOT NULL,
	historique jsonb NOT NULL,
...
>>>>>>> e975edece (feat: indicatif usagers + indicatif structure)
    `
  );
}
