...
export class autoMigration1604995302358 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "app_user" ("uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "version" integer NOT NULL, "_id" text, "email" text NOT NULL, "fonction" text, "id" integer NOT NULL, "lastLogin" TIMESTAMP WITH TIME ZONE, "nom" text NOT NULL, "password" text NOT NULL, "prenom" text NOT NULL, "role" text NOT NULL DEFAULT 'simple', "structureId" integer NOT NULL, "temporaryTokens" jsonb, "mails" jsonb NOT NULL DEFAULT '{"guide": false, "import": false}', "passwordLastUpdate" TIMESTAMP WITH TIME ZONE, "verified" boolean NOT NULL DEFAULT false, CONSTRAINT "UQ_b3109212e51e21b8acd695f7dab" UNIQUE ("_id"), CONSTRAINT "UQ_3fa909d0e37c531ebc237703391" UNIQUE ("email"), CONSTRAINT "UQ_22a5c4a3d9b2fb8e4e73fc4ada1" UNIQUE ("id"), CONSTRAINT "PK_a58dc229068f494a0360b170322" PRIMARY KEY ("uuid"))`
    );
