  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    if (
      ...
      await queryRunner.query(
        `CREATE TABLE "usager_options_history" ("uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "version" integer NOT NULL, "usagerUUID" uuid NOT NULL, "userId" integer NOT NULL, "userName" text NOT NULL, "structureId" integer NOT NULL, "action" text NOT NULL, "type" text NOT NULL, "nom" text, "prenom" text, "adresse" text, "actif" boolean NOT NULL DEFAULT false, "dateDebut" date NOT NULL, "dateFin" date NOT NULL, "dateNaissance" date, CONSTRAINT "PK_429ff2cc277afdc9e1ce5ac8d63" PRIMARY KEY ("uuid"))`
      );
      await queryRunner.query(
      ...
      await queryRunner.query(
        `ALTER TABLE "usager" ALTER COLUMN "options" SET DEFAULT '{ "transfert":{ "actif":false, "nom":null, "adresse":null, "dateDebut":null, "dateFin":null },"procuration":{ "actif":null, "nom":null, "prenom":null, "dateFin":null, "dateDebut":null, "dateNaissance":null }, "npai":{ "actif":false, "dateDebut":null }, "portailUsagerEnabled":false }'`
      );
      await queryRunner.query(
