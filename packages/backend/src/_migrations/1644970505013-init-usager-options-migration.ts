  ...
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    if (
      ...
      appLogger.warn("[MIGRATION] Création de usager_options_history");
      await queryRunner.query(
        `CREATE TABLE "usager_options_history" ("uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "version" integer NOT NULL, "usagerUUID" uuid NOT NULL, "userId" integer, "userName" text, "structureId" integer, "action" text NOT NULL, "type" text NOT NULL, "nom" text, "prenom" text, "adresse" text, "actif" boolean NOT NULL DEFAULT false, "dateDebut" date, "dateFin" date, "dateNaissance" date, CONSTRAINT "PK_429ff2cc277afdc9e1ce5ac8d63" PRIMARY KEY ("uuid"))`
      );
