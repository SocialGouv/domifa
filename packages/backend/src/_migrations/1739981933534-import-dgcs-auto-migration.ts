...
export class ManualMigration1739981933534 implements MigrationInterface {
  ...
  public async up(): Promise<void> {
    if (
      ...
      await openDataPlaceRepository.delete({});
      ...
      try {
        ...
        for await (const row of jsonData) {
          ...
          const address = `${cleanAddress(row.adresse)}, ${city} ${postalCode}`;
