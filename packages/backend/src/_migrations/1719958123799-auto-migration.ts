  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    if (
      ...
      await queryRunner.query(
        `DROP INDEX IF EXISTS "public"."IDX_2dc55096563e5e2a6db3b83c0c"`
      );
      await queryRunner.query(
        `DROP INDEX IF EXISTS "public"."IDX_d2145fd3e0c677e9f1f9763467"`
      );
      await queryRunner.query(
        `DROP INDEX IF EXISTS "public"."IDX_d92188af7573662f6be7199eda"`
      );
      await queryRunner.query(
        `DROP INDEX IF EXISTS "public"."IDX_32f34de1c043658f4843e62218"`
      );
      await queryRunner.query(
        `DROP INDEX IF EXISTS "public"."IDX_12b6501ee34f7b56be08b6536d"`
      );
      await queryRunner.query(
        `DROP INDEX IF EXISTS "public"."IDX_b3d70227bb45dd8060e256ee33"`
      );
      await queryRunner.query(
        `DROP INDEX IF EXISTS "public"."IDX_78061fee381f67924d9a659dc6"`
      );
      await queryRunner.query(
        `DROP INDEX IF EXISTS "public"."IDX_b86af851802a2a2f3a2ab549e8"`
      );
      await queryRunner.query(
        `DROP INDEX IF EXISTS "public"."IDX_f11adaadacdb25438cf2f92f1f"`
      );
