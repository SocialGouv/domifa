import { OTP_EXPIRATION_MINUTES } from "@domifa/common";
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                  <td width="50%" valign="middle" style="text-align: left;">
                    <img src="https://domifa.fabrique.social.gouv.fr/assets/images/discover/partenaire-mtssf.svg" alt="Minist&egrave;re du Travail, de la Sant&eacute;, des Solidarit&eacute;s et des Familles" width="100" style="display: block; width: 100px; height: auto;"/>
                  </td>
          ...
          <tr>
            <td style="padding: 25px 15px 0 15px;">
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                ...
                <tr>
                  <td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; line-height: 1.5; color: #000000; padding-bottom: 15px;">
                    Ce code est valable seulement <strong>${OTP_EXPIRATION_MINUTES} minutes</strong>. Au-del&agrave; de ce d&eacute;lai, vous devrez demander un nouveau code.
                  </td>
                </tr>
