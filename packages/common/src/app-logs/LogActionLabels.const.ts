...
export const LOG_ACTION_LABELS: Record<LogAction, string> = {
  ...
  USER_EMAIL_SELF_UPDATE_REQUESTED:
    "Demande de modification de l'adresse email par l'utilisateur",
  USER_EMAIL_SELF_UPDATE_CONFIRMED:
    "Confirmation de la modification de l'adresse email par l'utilisateur",
