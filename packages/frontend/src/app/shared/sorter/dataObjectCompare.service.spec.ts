...
it("dataObjectCompare.compareAttributes", () => {
  ...
  expect(
    dataObjectCompare.compareObjects(I1, I3, {
      attributes: (item) => [
        {
          value: item.cat,
        },
  ...
  expect(
    dataObjectCompare.compareObjects(I1, I4, {
      attributes: (item) => [
        {
          value: item.cat,
        },
...
it("dataObjectCompare.objectsEquals", () => {
  ...
  expect(
    dataObjectCompare.objectsEquals(I1, I3, {
  ...
  expect(
    dataObjectCompare.objectsEquals(I1, I4, {
      attributes: (item) => [item.cat, item.score],
    })
  ).toEqual(true);
