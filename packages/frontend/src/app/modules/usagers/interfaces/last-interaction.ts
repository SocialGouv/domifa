  ...
  constructor(lastInteraction?: any) {
    ...
    this.courrierIn =
      lastInteraction && lastInteraction.courrierIn !== null
        ...
        : null;
    this.courrierOut =
      lastInteraction && lastInteraction.courrierOut !== null
        ? new Date(lastInteraction.courrierOut)
        : null;
    this.recommandeIn =
      lastInteraction && lastInteraction.recommandeIn !== null
        ? new Date(lastInteraction.recommandeIn)
        : null;
    this.recommandeOut =
      lastInteraction && lastInteraction.recommandeOut !== null
        ? new Date(lastInteraction.recommandeOut)
        : null;
    this.appel =
      lastInteraction && lastInteraction.appel !== null
        ? new Date(lastInteraction.appel)
        : null;
    this.visite =
      lastInteraction && lastInteraction.visite !== null
        ? new Date(lastInteraction.visite)
        : null;
  }
}
