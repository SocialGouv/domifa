...
Pour créer un patch sans embarqué ce qui a été mergé sur master depuis, il faut créer une branche à partir du dernier tag mis en prod, et commiter le tag dessus: [](https://github.com/semantic-release/semantic-release/blob/master/docs/recipes/maintenance-releases.md#releasing-a-feature-for-version-1x-users)
